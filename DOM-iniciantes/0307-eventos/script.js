//https://www.origamid.com/slide/javascript-completo-es6/#/0307-eventos/1
...

{
  ...
  function executarCallback(event) {
    const currentTarget = event.currentTarget; // this 'referente ao item setado do evento
    const target = event.target; // onde o clique ocorreu
    const type = event.type; // tipo de evento
    const path = event.path;//caminho de evento
...
//THIS (Geralmente igual ao event.currentTarget)
